    ...
    <div className="flex flex-col items-center justify-center gap-4">
      <div className="relative flex items-center justify-center">
        ...
        <motion.div
          ...
          className="h-16 w-16 rounded-full border-t-2 border-b-2 border-white/20"
        />
        ...
        <motion.div
          ...
          className="absolute h-10 w-10 rounded-full border-r-2 border-l-2 border-[#00e571]"
        />
        ...
        <motion.div
          ...
          className="absolute h-4 w-4 rounded-full bg-white shadow-[0_0_15px_rgba(255,255,255,0.8)]"
        />
      </div>
      <motion.p
        initial={{ opacity: 0 }}
...
export const LoaderFour = ({ text = "Loading..." }: { text?: string }) => {
  return (
    <div className="relative font-bold text-black perspective-[1000px] dark:text-white">
      <motion.span
        animate={{
          skewX: [0, -40, 0], // Changed skew to skewX
          scaleX: [1, 2, 1],
        }}
        transition={{
          duration: 0.05,
...
export function LoaderOneDemo() {
  return (
    <div className="p-4 bg-black/90 rounded-md">
      <LoaderOne />
    </div>
  );
}
