    ...
    <section className="py-24 relative bg-black border-t-2 border-white/20">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
           ...
           <div className="absolute top-1/2 left-0 w-full h-0.5 bg-gradient-to-r from-red-900 via-purple-900 to-blue-900 -z-10 hidden md:block" />
            ...
            <MethodologyCard 
                ...
                bullets={["Penetration Testing", "Social Engineering", "Exploit Development"]}
                color="red"
                delay={0.1}
            />
            ...
            <MethodologyCard 
                ...
                bullets={["SIEM Operations", "Threat Hunting", "Forensics Analysis"]}
                color="blue"
                delay={0.3}
            />
        </div>
...
function MethodologyCard({ title, icon, description, bullets, color, delay, isCenter }: MethodologyCardProps) {
    const colorMap = {
        red: {
    ...
    return (
        ...
        >
            <div className={cn("mb-6 p-4 border-2 rounded-none", theme.border, theme.text, "bg-white/5")}>
                {icon}
            </div>

            <h3 className={cn("text-2xl font-black uppercase mb-4", theme.text)}>{title}</h3>
